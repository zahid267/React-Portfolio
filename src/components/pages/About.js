        ...
        <h2>About Me</h2>
               <div> 
                <figure>
					...
					I have completed a <b>Coding Boot Camp Certificate (February 2021 - July 2021) from Charlton University, Ottawa, Canada.</b><br />
A 24-week intensive program focused on gaining technical programming skills in Gits, HTML5, CSS3, Javascript, JQuary, Bootstrap, NodeJS, JSON, MySQL, MongoDB, Express, Handlebars, MERN, GraphQL, Hooks, Mutations & ReactJS.
